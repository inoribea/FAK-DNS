...
# 远程脚本地址
REMOTE_SCRIPT_URL="https://raw.githubusercontent.com/inoribea/FAK-DNS/refs/heads/bash/adg.sh"  # 替换为实际远程脚本地址
# 当前脚本路径
CURRENT_SCRIPT_PATH="$0"
# 快捷命令路径
SHORTCUT_PATH="/bin/adg"

# 文件更新配置
FILE_URL="https://raw.githubusercontent.com/inoribea/FAK-DNS/master/converted/FAK-DNS.txt"
TARGET_DIR="/etc/AdGuardHome"
...
restart_adguard() {
    ...
    if service "$ADGUARD_SERVICE" restart; then
